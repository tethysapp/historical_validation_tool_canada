...
def home(request):
    ...
    return render(request, 'historical_validation_tool_canada/home.html', context)
...
def get_popup_response(request):
    ...
    try:
        ...
        '''Get Observed Data'''
        df = pd.read_csv(os.path.join(app.get_app_workspace().path, 'Discharge_Data/{}.csv'.format(codEstacion)), index_col=0)
...
def get_hydrographs(request):
    ...
    try:
        ...
        return render(request, 'historical_validation_tool_canada/gizmo_ajax.html', context)
...
def get_time_series_bc(request):
    ...
    try:
        ...
        url_rt = 'https://dd.weather.gc.ca/hydrometric/csv/{0}/daily/{0}_{1}_daily_hydrometric.csv'.format(province,
                                                                                                           codEstacion)
